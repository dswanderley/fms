...
from torchvision.models.detection.faster_rcnn import TwoMLPHead, RoIHeads, FastRCNNPredictor
...
class MyRPN(RegionProposalNetwork):
    ...
    def compute_loss(self, objectness, pred_bbox_deltas, labels, regression_targets):
        ...
        objectness_loss = focal_loss(
                                    objectness[sampled_inds].unsqueeze(1),
                                    labels[sampled_inds].type(torch.int64),
                                    alpha=0.25,
                                    reduction='sum')
